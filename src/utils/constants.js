...
//create a list of predefined queries --> doing in Utilities

//List of dataType -> for dispatch (page -> withFetch -> dispatch -> CARD)
export const IS_MOVIE_DATA = 'movie_data';
export const IS_PERSON_DATA = 'person_data';
